...
export function registerWriteCommand(program: Command): void {
  program
    .command('write')
    .description('Write a wiki page (supports --dir for wiki/entities/concepts)')
    .argument('<slug>', 'Page slug')
    .option('--title <title>', 'Page title')
    .option('--body <body>', 'Page body (inline or from stdin)')
    .option('--summary <summary>', 'Change summary')
    .option('--dir <dir>', 'Target directory: wiki (default), entities, concepts, or subdir like wiki/messi')
